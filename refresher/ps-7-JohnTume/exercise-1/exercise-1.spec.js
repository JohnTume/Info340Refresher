...
import { App, SenatorTable, TableHeader, Senator } from './src/App';
//solution classes
...
//problem config
const JS_FILE_PATH_ROOT = __dirname + 'src/';
...
describe('The Senator listing app', () => {
    ...
    describe('implements a `Senator` component', () => {
        ...
        it('renders the correct cells based on the props', () => {
            ...
            let phoneLink = expect(cells.at(2).find('a').html()).toEqual('<a href="tel:123-456-789">123-456-789</a>'); //just hard-code it for now
            let twitterOptions = ['<a href="https://twitter.com/test1">@test1</a>', '<a href="https://twitter.com/@test1">@test1</a>'] //allow @
            expect(twitterOptions).toContain(cells.at(3).find('a').html());
        })
    })

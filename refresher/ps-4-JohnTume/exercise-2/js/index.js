...
/* Create and log a variable `twelveString` that is the result of passing
    the character sting "8" (in quotes) to your addFour() function. 
    Consider what this tells you about how the function works. */
...
// five cards from the `deck`. (not required, but will help catch errors).
...
/* Bonus challenge (for fun, not for points):
    define a function `hasPair()` that takes in an array of 
